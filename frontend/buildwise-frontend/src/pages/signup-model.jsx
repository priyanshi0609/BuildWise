          ...
          >
            ...
            <div className="p-8">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 mt-1">Join BuildWise and start optimizing your projects</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="text-center text-sm text-gray-600">
                  ...
                  <button
                    ...
                    onClick={() => {
                      onClose()
                      // You would typically open the login modal here
                      // For this example, we'll just close the signup modal
                    }}
